$(function(){
 ...
 var clearRs = null;
  ...
  function setData(e){
    ...
    for(var i=0; i< obj.length; i++){
      var $item = $(['<li class="list-group-item">',
                      ...
                      '  <div class="row">',
                      '    <div class="col-md-4 col-xs-12 imgWrap">',
                      '      <a href="javascript:;" class="smallImg"><img ></a>',
                      '    </div>',
                      '    <div class="col-md-8 col-xs-12 contentWrap">',
                      '      <a href="javascript:;" class="btn btn-default delete">删除</a>',
                      '      <div class="panel panel-default">',
                      '        <div class="panel-heading">页面URL地址</div>',
                      '        <div class="panel-body url"></div>',
                      '      </div>',
                      '      <div class="panel panel-default">',
                      '        <div class="panel-heading">敏感词汇</div>',
                      '        <div class="panel-body keyword"></div>',
                      '      </div>',
                      '    </div>',
                      '  </div>',
                      '</li>'].join(' '));
  ...
  function setPagination(e){
    ...
    var $prev = $(['<li>',
                    '  <a href="javascript:;" data-index="prev" aria-label="Previous">',
                    '    <span aria-hidden="true">&laquo;</span>',
                    '  </a>',
                    '</li>'].join(' '));
    var $next = $(['<li>',
                    '  <a href="javascript:;" data-index="next" aria-label="Next">',
